...
A complete, automated system for testing your production database (Cap & Collar Supply Co.) with your open-source EcommerceStarter codebase.
...
### Your Challenge:
> "I want to actively develop my open-source EcommerceStarter while also running Cap & Collar Supply Co. in production, without risking production data or compromising production secrets."
