...
**What happens:**
1. ? Backs up `EcommerceStarter` database
...
.\Test-Migration.ps1 `
    ...
    -SourceDatabase "EcommerceStarter" `   # Production database
...
Source Database: EcommerceStarter
...
??? Temp\
    ??? DatabaseBackups\
        ??? EcommerceStarter_*.bak        ? Backups here
