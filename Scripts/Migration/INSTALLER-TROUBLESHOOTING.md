...
Get-Acl "C:\inetpub\capandcollar" | Format-List

# Check if directory is locked
Get-Process | Where-Object { $_.Path -like "*inetpub\capandcollar*" }
```
...
New-WebSite -Name "MyStore" -Port 8080 -PhysicalPath "C:\inetpub\capandcollar"
```
...
Add-MpPreference -ExclusionPath "C:\inetpub\capandcollar"
```
...
Remove-WebAppPool -Name "MyStore" -Confirm
Remove-Item "C:\inetpub\capandcollar" -Recurse -Force
