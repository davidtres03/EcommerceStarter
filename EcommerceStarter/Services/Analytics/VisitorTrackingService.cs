...
namespace EcommerceStarter.Services.Analytics
{
    ...
    public class VisitorTrackingService : IVisitorTrackingService
    {
        ...
        /// </summary>
        private void ParseUserAgent(VisitorSession session)
        {
            ...
            try
            {
                ...
                var clientInfo = uaParser.Parse(session.UserAgent);
                ...
                else if (clientInfo.Device.Family.Contains("Mobile") || 
                         clientInfo.Device.Family.Contains("Phone"))
                {
