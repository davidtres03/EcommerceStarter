...
public class InstallationConfig : INotifyPropertyChanged
{
    ...
    public bool EnableHttps { get; set; } = false; // Whether to create/bind HTTPS and certificate
    ...
    // Installation Paths
    // Default to instance-specific directory structure: C:\inetpub\wwwroot\{SiteName}
    public string InstallationPath { get; set; } = @"C:\inetpub\wwwroot\MyStore";
