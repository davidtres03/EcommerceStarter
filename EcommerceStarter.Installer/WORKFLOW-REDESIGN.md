...
?                                                  ?
?  ?? Store: EcommerceStarter Supply Co.              ?
?  ?? Location: C:\inetpub\ecommercestarter          ?
...
public async Task<ExistingInstallation?> DetectExistingInstallationAsync()
{
    ...
    return new ExistingInstallation
    {
        ...
        DatabaseName = database,  // ? This is where "MyStore" vs "EcommerceStarter" comes from!
...
3. **Connection String** ? `Database=EcommerceStarter` ? **THIS IS IT!**
